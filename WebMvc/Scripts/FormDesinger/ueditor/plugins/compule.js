UE.compule = {
    ...
    getSubTableHtml: function ($control)
    {
        ...
        else //弹出方式
        {
            ...
            script1 += 'new RoadUI.Window().open({url:"/WorkFlowRun/SubTableEdit?flowid=@FlowID&stepid=@StepID&secondtableeditform=' + subtableJSON.editform + '&primarytableid=" + instanceid + "&secondtablerelationfield=' + subtableJSON.secondtable + '.' + subtableJSON.secondtablerelationfield + '&appid="+appid,openerid:tabid,title:"添加",height:' + (subtableJSON.displaymodeheight || 500) + ',width:' + (subtableJSON.displaymodewidth || 800) + '});';
            script1 += '}';
            ...
            script1 += 'var tabid=\'@Request.QueryString["tabid"]\';';
            script1 += 'var appid = \'@Request.QueryString["appid"]\';';
            script1 += 'new RoadUI.Window().open({url:"/WorkFlowRun/SubTableEdit?flowid=@FlowID&stepid=@StepID&secondtableeditform=' + subtableJSON.editform + '&secondtable=' + subtableJSON.secondtable + '&secondtableconnid=@DBConnID&secondtableprimarykey=' + subtableJSON.secondtableprimarykey + '&instanceid="+id+"&primarytableid="+instanceid+"&secondtablerelationfield=' + subtableJSON.secondtable + '.' + subtableJSON.secondtablerelationfield + '&appid="+appid,openerid:tabid,title:"编辑",height:' + (subtableJSON.displaymodeheight || 500) + ',width:' + (subtableJSON.displaymodewidth || 800) + '});';
            script1 += '}';
