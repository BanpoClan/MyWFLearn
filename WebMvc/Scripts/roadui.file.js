    ...
    this.init = function ($files)
    {
        $files.each(function ()
        {
            ...
            $but.bind("click", function ()
            {
                ...
                new RoadUI.Window().open({ id: "file_" + id, url: (top.rootdir || "") + "/Controls/UploadFiles/Index?eid=" + id + "&files=" + val + "&filetype=" + filetype, width: 500, height: 400, title: "附件管理", showclose: false });
            });
