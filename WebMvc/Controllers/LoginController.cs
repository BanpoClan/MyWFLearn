...
namespace WebMvc.Controllers
{
    public class LoginController : Controller
    {
        ...
        {
            ViewBag.IsVcodeSessionKey = MyCreek.Utility.Keys.SessionKeys.IsValidateCode.ToString();
            ViewBag.Forcescript = "";
            return View();
        }
        ...
        {
            string code;
            System.IO.MemoryStream ms = MyCreek.Utility.Tools.GetValidateImg(out code, Url.Content("~/Images/vcodebg.png"));
            System.Web.HttpContext.Current.Session[MyCreek.Utility.Keys.SessionKeys.ValidateCode.ToString()] = code;
