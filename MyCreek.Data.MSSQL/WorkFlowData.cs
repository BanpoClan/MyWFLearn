...
{
    public class WorkFlowData : MyCreek.Data.Interface.IWorkFlowData
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">MyCreek.Data.Model.WorkFlowData实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(MyCreek.Data.Model.WorkFlowData model)
        {
        ...
        /// </summary>
        /// <param name="model">MyCreek.Data.Model.WorkFlowData实体类</param>
        public int Update(MyCreek.Data.Model.WorkFlowData model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.WorkFlowData> DataReaderToList(SqlDataReader dataReader)
        {
            List<MyCreek.Data.Model.WorkFlowData> List = new List<MyCreek.Data.Model.WorkFlowData>();
            MyCreek.Data.Model.WorkFlowData model = null;
            while (dataReader.Read())
            {
                model = new MyCreek.Data.Model.WorkFlowData();
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.WorkFlowData> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowData";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<MyCreek.Data.Model.WorkFlowData> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public MyCreek.Data.Model.WorkFlowData Get(Guid id)
        {
        ...
        /// 查询一个实例ID所有记录
        /// </summary>
        public List<MyCreek.Data.Model.WorkFlowData> GetAll(Guid instanceID)
        {
