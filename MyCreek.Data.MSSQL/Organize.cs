...
namespace MyCreek.Data.MSSQL
{
    public class Organize : MyCreek.Data.Interface.IOrganize
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">MyCreek.Data.Model.Organize实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.Organize> DataReaderToList(SqlDataReader dataReader)
        {
            List<MyCreek.Data.Model.Organize> List = new List<MyCreek.Data.Model.Organize>();
            MyCreek.Data.Model.Organize model = null;
            while (dataReader.Read())
            {
                model = new MyCreek.Data.Model.Organize();
        ...
        public List<MyCreek.Data.Model.Organize> GetAll()
        {
            ...
            List<MyCreek.Data.Model.Organize> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        {
            string sql = "SELECT * FROM Organize WHERE ID IN(" + MyCreek.Utility.Tools.GetSqlInString(number) + ") ORDER BY Depth";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<MyCreek.Data.Model.Organize> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.Organize> GetAllChild(string number)
        {
