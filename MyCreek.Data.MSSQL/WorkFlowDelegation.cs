...
namespace MyCreek.Data.MSSQL
{
    public class WorkFlowDelegation : MyCreek.Data.Interface.IWorkFlowDelegation
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.WorkFlowDelegation> DataReaderToList(SqlDataReader dataReader)
        {
        ...
        public List<MyCreek.Data.Model.WorkFlowDelegation> GetNoExpiredList()
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]{
				new SqlParameter("@EndTime", SqlDbType.DateTime){ Value = MyCreek.Utility.DateTimeNew.Now }
			};
            SqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<MyCreek.Data.Model.WorkFlowDelegation> List = DataReaderToList(dataReader);
            dataReader.Close();
