...
{
    public class RoleApp : MyCreek.Data.Interface.IRoleApp
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">MyCreek.Data.Model.RoleApp实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.RoleApp> DataReaderToList(SqlDataReader dataReader)
        {
            List<MyCreek.Data.Model.RoleApp> List = new List<MyCreek.Data.Model.RoleApp>();
            MyCreek.Data.Model.RoleApp model = null;
            while (dataReader.Read())
            {
                model = new MyCreek.Data.Model.RoleApp();
        ...
        public List<MyCreek.Data.Model.RoleApp> GetAll()
        {
            ...
            List<MyCreek.Data.Model.RoleApp> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
