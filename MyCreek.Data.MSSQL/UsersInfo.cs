...
{
    public class UsersInfo : MyCreek.Data.Interface.IUsersInfo
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.UsersInfo> DataReaderToList(SqlDataReader dataReader)
        {
        ...
        public List<MyCreek.Data.Model.UsersInfo> GetAll()
        {
            ...
            List<MyCreek.Data.Model.UsersInfo> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
