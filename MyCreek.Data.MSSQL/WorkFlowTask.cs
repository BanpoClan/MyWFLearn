...
namespace MyCreek.Data.MSSQL
{
    public class WorkFlowTask : MyCreek.Data.Interface.IWorkFlowTask
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.WorkFlowTask> DataReaderToList(SqlDataReader dataReader)
        {
        ...
        public int Completed(Guid taskID, string comment = "", bool isSign = false, int status = 2, string note="")
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]{
                ...
                new SqlParameter("@CompletedTime1", SqlDbType.DateTime){ Value = MyCreek.Utility.DateTimeNew.Now },
