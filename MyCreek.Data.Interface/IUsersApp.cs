...
namespace MyCreek.Data.Interface
{
    public interface IUsersApp
    {
        ...
        /// 新增
        /// </summary>
        int Add(MyCreek.Data.Model.UsersApp model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(MyCreek.Data.Model.UsersApp model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<MyCreek.Data.Model.UsersApp> GetAll();
        ...
        /// 查询下级记录
        /// </summary>
        List<MyCreek.Data.Model.UsersApp> GetChild(Guid id);
