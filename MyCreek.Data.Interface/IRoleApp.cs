...
namespace MyCreek.Data.Interface
{
    public interface IRoleApp
    {
        ...
        /// 新增
        /// </summary>
        int Add(MyCreek.Data.Model.RoleApp model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(MyCreek.Data.Model.RoleApp model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<MyCreek.Data.Model.RoleApp> GetAll();
        ...
        /// 查询一个角色所有记录
        /// </summary>
        List<MyCreek.Data.Model.RoleApp> GetAllByRoleID(Guid roleID);
        ...
        /// 查询下级记录
        /// </summary>
        List<MyCreek.Data.Model.RoleApp> GetChild(Guid id);
