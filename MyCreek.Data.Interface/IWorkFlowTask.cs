...
namespace MyCreek.Data.Interface
{
    public interface IWorkFlowTask
    {
        ...
        /// 新增
        /// </summary>
        int Add(MyCreek.Data.Model.WorkFlowTask model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(MyCreek.Data.Model.WorkFlowTask model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<MyCreek.Data.Model.WorkFlowTask> GetAll();
        ...
        /// <returns></returns>
        List<MyCreek.Data.Model.WorkFlowTask> GetTasks(Guid userID, out string pager, string query = "", string title = "", string flowid = "", string sender = "", string date1 = "", string date2 = "", int type = 0);
        ...
        /// <returns></returns>
        List<MyCreek.Data.Model.WorkFlowTask> GetInstances(Guid[] flowID, Guid[] senderID, Guid[] receiveID, out string pager, string query = "", string title = "", string flowid = "", string date1 = "", string date2 = "", int status = 0);
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        List<MyCreek.Data.Model.WorkFlowTask> GetTaskList(Guid flowID, Guid groupID);
        ...
        /// <returns></returns>
        List<MyCreek.Data.Model.WorkFlowTask> GetTaskList(Guid taskID, bool isStepID = true);
