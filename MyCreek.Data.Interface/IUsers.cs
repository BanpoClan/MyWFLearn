...
namespace MyCreek.Data.Interface
{
    public interface IUsers
    {
        ...
        /// 新增
        /// </summary>
        int Add(MyCreek.Data.Model.Users model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(MyCreek.Data.Model.Users model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<MyCreek.Data.Model.Users> GetAll();
        ...
        /// 根据帐号查询一条记录
        /// </summary>
        MyCreek.Data.Model.Users GetByAccount(string account);
