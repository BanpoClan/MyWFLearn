...
{
    public class AppLibrary : MyCreek.Data.Interface.IAppLibrary
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">MyCreek.Data.Model.AppLibrary实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.AppLibrary> DataReaderToList(OracleDataReader dataReader)
        {
            List<MyCreek.Data.Model.AppLibrary> List = new List<MyCreek.Data.Model.AppLibrary>();
            MyCreek.Data.Model.AppLibrary model = null;
            while (dataReader.Read())
            {
                model = new MyCreek.Data.Model.AppLibrary();
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.AppLibrary> GetAll()
        {
            string sql = "SELECT * FROM AppLibrary";
            OracleDataReader dataReader = dbHelper.GetDataReader(sql);
            List<MyCreek.Data.Model.AppLibrary> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public MyCreek.Data.Model.AppLibrary Get(Guid id)
        {
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.AppLibrary> GetPagerData(out string pager, string query = "", string order = "Type,Title", int size = 15, int number = 1, string title = "", string type = "", string address = "")
        {
            ...
            {
                WHERE.AppendFormat("AND Type IN({0}) ", MyCreek.Utility.Tools.GetSqlInString(type));
            }
        ...
        /// 查询一个类别下所有记录
        /// </summary>
        public List<MyCreek.Data.Model.AppLibrary> GetAllByType(string types)
        {
            string sql = "SELECT * FROM AppLibrary WHERE Type IN(" + MyCreek.Utility.Tools.GetSqlInString(types) + ")";
            OracleDataReader dataReader = dbHelper.GetDataReader(sql);
            List<MyCreek.Data.Model.AppLibrary> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        ...
        {
            string sql = "DELETE FROM AppLibrary WHERE ID IN(" + MyCreek.Utility.Tools.GetSqlInString(idArray) + ")";
