...
{
    public class DBConnection : MyCreek.Data.Interface.IDBConnection
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">MyCreek.Data.Model.DBConnection实体类</param>
        ...
        public int Add(MyCreek.Data.Model.DBConnection model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":Name", OracleDbType.Varchar2, 500){ Value = model.Name },
				new OracleParameter(":Type", OracleDbType.Varchar2, 500){ Value = model.Type },
				new OracleParameter(":ConnectionString", OracleDbType.Clob){ Value = model.ConnectionString },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.DBConnection> DataReaderToList(OracleDataReader dataReader)
        {
            List<MyCreek.Data.Model.DBConnection> List = new List<MyCreek.Data.Model.DBConnection>();
            MyCreek.Data.Model.DBConnection model = null;
            while (dataReader.Read())
            {
                model = new MyCreek.Data.Model.DBConnection();
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.DBConnection> GetAll()
        {
            string sql = "SELECT * FROM DBConnection";
            OracleDataReader dataReader = dbHelper.GetDataReader(sql);
            List<MyCreek.Data.Model.DBConnection> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
