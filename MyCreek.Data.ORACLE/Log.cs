...
{
    public class Log : MyCreek.Data.Interface.ILog
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<MyCreek.Data.Model.Log> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        public List<MyCreek.Data.Model.Log> GetAll()
        {
            ...
            List<MyCreek.Data.Model.Log> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
