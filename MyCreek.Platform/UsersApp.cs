...
namespace MyCreek.Platform
{
    ...
    {
        private MyCreek.Data.Interface.IUsersApp dataUsersApp;
        public UsersApp()
        {
        ...
        {
            string cacheKey = MyCreek.Utility.Keys.CacheKeys.UsersApp.ToString();
            if (fromCache)
            {
                ...
                if (obj == null || !(obj is System.Data.DataTable))
                {
                    ...
                    MyCreek.Cache.IO.Opation.Insert(cacheKey, dt);
                    return dt;
                }
                else
                {
        ...
        public void AppendUserApps(Guid userID, Guid parentID, List<MyCreek.Data.Model.RoleApp> appList)
        {
            ...
            foreach (var userApp in userApps)
            {
                ...
                {
                    MyCreek.Data.Model.RoleApp app = new MyCreek.Data.Model.RoleApp();
        ...
        /// 查询下级记录
        /// </summary>
        public List<MyCreek.Data.Model.UsersApp> GetChilds(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<MyCreek.Data.Model.UsersApp> GetAllChilds(Guid id)
        {
        ...
        private void addChilds(Guid id, List<MyCreek.Data.Model.UsersApp> list)
        {
