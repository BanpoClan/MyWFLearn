...
namespace MyCreek.Platform
{
    ...
    {
        private MyCreek.Data.Interface.IWorkFlowData dataWorkFlowData;
        public WorkFlowData()
        {
            this.dataWorkFlowData = Data.Factory.Factory.GetWorkFlowData();
        }
        /// <summary>
        /// 新增
        /// </summary>
        ...
        public string GetLinkFieldValue(string linkString, Guid instanceID)
        {
            ...
            if (array.Length == 3)
            {
                ...
                value = new MyCreek.Platform.DBConnection().GetFieldValue(array[2], key);
            }
            return value;
        }
        ...
        public Guid CreateData(Guid flowID, string pkValue)
        {
            ...
            MyCreek.Data.Model.WorkFlowData wfdata = new MyCreek.Data.Model.WorkFlowData();
