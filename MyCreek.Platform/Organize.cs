...
namespace MyCreek.Platform
{
    public class Organize
    {
        ...
        private MyCreek.Data.Interface.IOrganize dataOrganize;
        public Organize()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(MyCreek.Data.Model.Organize model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(MyCreek.Data.Model.Organize model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.Organize> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public MyCreek.Data.Model.Organize Get(Guid id)
        {
        ...
        /// 根据根记录
        /// </summary>
        public MyCreek.Data.Model.Organize GetRoot()
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<MyCreek.Data.Model.Organize> GetChilds(Guid ID)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<MyCreek.Data.Model.Users> GetAllUsers(Guid id)
        {
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.Users> GetAllUsers(string idString)
        {
            if (idString.IsNullOrEmpty())
            {
                return new List<MyCreek.Data.Model.Users>();
            }
            string[] idArray = idString.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
            List<MyCreek.Data.Model.Users> userList = new List<MyCreek.Data.Model.Users>();
        ...
        private void addWorkGroupUsers(List<MyCreek.Data.Model.Users> userList, MyCreek.Data.Model.WorkGroup wg)
        {
        ...
        /// 查询一个组织的所有上级
        /// </summary>
        public List<MyCreek.Data.Model.Organize> GetAllParent(string number)
        {
            return number.IsNullOrEmpty() ? new List<MyCreek.Data.Model.Organize>() : dataOrganize.GetAllParent(number);
        }

        /// <summary>
        /// 查询一个组织的所有上级
        /// </summary>
        public List<MyCreek.Data.Model.Organize> GetAllParent(Guid id)
        {
            var org = Get(id);
            if (org == null)
            {
                return new List<MyCreek.Data.Model.Organize>();
            }
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.Organize> GetAllChilds(string number)
        {
            return number.IsNullOrEmpty() ? new List<MyCreek.Data.Model.Organize>() : dataOrganize.GetAllChild(number);
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<MyCreek.Data.Model.Organize> GetAllChilds(Guid id)
        {
            var org = Get(id);
            if (org == null)
            {
