...
namespace MyCreek.Platform
{
    public class OnlineUsers
    {
        ...
        /// 缓存键
        /// </summary>
        private string key = MyCreek.Utility.Keys.CacheKeys.OnlineUsers.ToString();

        /// <summary>
        /// 得到所有在线用户表
        /// </summary>
        /// <returns></returns>
        public List<MyCreek.Data.Model.OnlineUsers> GetAll()
        {
            object obj = MyCreek.Cache.IO.Opation.Get(key);
            return obj != null && obj is List<MyCreek.Data.Model.OnlineUsers> ? obj as List<MyCreek.Data.Model.OnlineUsers> : new List<MyCreek.Data.Model.OnlineUsers>();
        }

        private void set(List<MyCreek.Data.Model.OnlineUsers> list)
        {
            if (list == null) return;
        ...
        {
            var list = new List<MyCreek.Data.Model.OnlineUsers>();
            MyCreek.Cache.IO.Opation.Set(key, list);
            return true;
        }
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public MyCreek.Data.Model.OnlineUsers Get(Guid userID)
        {
            var list = GetAll();
