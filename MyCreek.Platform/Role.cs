...
namespace MyCreek.Platform
{
    public class Role
    {
        private MyCreek.Data.Interface.IRole dataRole;
        public Role()
        {
        ...
        /// <returns></returns>
        public string GetRoleOptions(string value = "", string hideID = "", IEnumerable<MyCreek.Data.Model.Role> roleList = null)
        {
