...
namespace MyCreek.Platform
{
    ...
    {
        private MyCreek.Data.Interface.IRoleApp dataRoleApp;
        public RoleApp()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(MyCreek.Data.Model.RoleApp model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(MyCreek.Data.Model.RoleApp model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.RoleApp> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public MyCreek.Data.Model.RoleApp Get(Guid id)
        {
        ...
        /// 查询一个角色所有记录
        /// </summary>
        public List<MyCreek.Data.Model.RoleApp> GetAllByRoleID(Guid roleID)
        {
        ...
        {
            string key = MyCreek.Utility.Keys.CacheKeys.RoleApp.ToString();
            ...
            if (obj == null || !(obj is System.Data.DataTable))
            {
                ...
                MyCreek.Cache.IO.Opation.Set(key, dt);
                return dt;
            }
            else
            {
        ...
        /// 查询下级记录
        /// </summary>
        public List<MyCreek.Data.Model.RoleApp> GetChild(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<MyCreek.Data.Model.RoleApp> GetAllChild(Guid id)
        {
            List<MyCreek.Data.Model.RoleApp> list = new List<MyCreek.Data.Model.RoleApp>();
        ...
        private void addChilds(List<MyCreek.Data.Model.RoleApp> list, Guid id)
        {
            var childs = GetChild(id);
            foreach (var child in childs)
            {
        ...
        {
            RoleApp RoleApp = new MyCreek.Platform.RoleApp();
        ...
        private void insertChilds(Guid oldID, Guid newID, Guid roleID, List<MyCreek.Data.Model.RoleApp> apps)
        {
        ...
        /// <param name="roleID"></param>
        /// <returns></returns>
        public MyCreek.Data.Model.RoleApp GetRootByRoleID(Guid roleID)
        {
