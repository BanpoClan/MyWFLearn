...
namespace MyCreek.Platform
{
    ...
    {
        private static string cacheKey = MyCreek.Utility.Keys.CacheKeys.UserRoles.ToString();
        private MyCreek.Data.Interface.IUsersRole dataUsersRole;
        public UsersRole()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public MyCreek.Data.Model.UsersRole Get(Guid userid, Guid roleid)
        {
        ...
        /// 根据一组用户ID查询记录
        /// </summary>
        public List<MyCreek.Data.Model.UsersRole> GetByUserIDArray(Guid[] memberIDArray)
        {
        ...
        /// 根据用户ID查询记录
        /// </summary>
        public List<MyCreek.Data.Model.UsersRole> GetByUserID(Guid memberID)
        {
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.UsersRole> GetByUserIDFromCache(Guid userID)
        {
        ...
        public void UpdateByUserID(Guid userID)
        {
            ...
            foreach (var role in roles)
            {
                ...
                {
                    busersRole.Add(new MyCreek.Data.Model.UsersRole()
                    {
                        IsDefault = true,
                        MemberID = userID,
                        RoleID = role.ID
        ...
        /// </summary>
        /// <returns></returns>
        public List<MyCreek.Data.Model.UsersRole> GetAllFromCache()
        {
            var obj = MyCreek.Cache.IO.Opation.Get(cacheKey);
            if (obj == null || !(obj is List<MyCreek.Data.Model.UsersRole>))
            {
                var list = GetAll();
            ...
            {
                return obj as List<MyCreek.Data.Model.UsersRole>;
            }
        }
