...
namespace MyCreek.Platform
{
    ...
    {
        private MyCreek.Data.Interface.IDBConnection dataDBConnection;
        public DBConnection()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(MyCreek.Data.Model.DBConnection model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(MyCreek.Data.Model.DBConnection model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.DBConnection> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            {
                string key = MyCreek.Utility.Keys.CacheKeys.DBConnnections.ToString();
                object obj = MyCreek.Cache.IO.Opation.Get(key);
                if (obj != null && obj is List<MyCreek.Data.Model.DBConnection>)
                {
                    return obj as List<MyCreek.Data.Model.DBConnection>;
                }
                else
                {
        ...
        /// 查询单条记录
        /// </summary>
        public MyCreek.Data.Model.DBConnection Get(Guid id)
        {
        ...
        /// <returns></returns>
        private string test_SqlServer(MyCreek.Data.Model.DBConnection conn)
        {
        ...
        /// <param name="conn"></param>
        /// <returns></returns>
        private string test_Oracle(MyCreek.Data.Model.DBConnection conn)
        {
        ...
        /// <returns></returns>
        private string testSql_SqlServer(MyCreek.Data.Model.DBConnection conn, string sql)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        private string testSql_Oracle(MyCreek.Data.Model.DBConnection conn, string sql)
        {
            using (OracleConnection sqlConn = new OracleConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="conn"></param>
        /// <returns></returns>
        private List<string> getTables_SqlServer(MyCreek.Data.Model.DBConnection conn)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="conn"></param>
        /// <returns></returns>
        private List<string> getTables_Oracle(MyCreek.Data.Model.DBConnection conn)
        {
        ...
        /// <returns></returns>
        private Dictionary<string, string> getFields_SqlServer(MyCreek.Data.Model.DBConnection conn, string table)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
...
WHERE object_id('{0}')=a.id ORDER BY a.colid", table);
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        private Dictionary<string, string> getFields_Oracle(MyCreek.Data.Model.DBConnection conn, string table)
        {
            using (OracleConnection sqlConn = new OracleConnection(conn.ConnectionString))
            {
                try
        ...
        /// <returns></returns>
        private string getFieldValue_SqlServer(MyCreek.Data.Model.DBConnection conn, string table, string field, Dictionary<string, string> pkFieldValue)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="pkFieldValue">主键和值字典</param>
        /// <returns></returns>
        private string getFieldValue_Oracle(MyCreek.Data.Model.DBConnection conn, string table, string field, Dictionary<string, string> pkFieldValue)
        {
            using (OracleConnection sqlConn = new OracleConnection(conn.ConnectionString))
            {
                try
        ...
        /// <returns></returns>
        private string getFieldValue_SqlServer(MyCreek.Data.Model.DBConnection conn, string table, string field, string pkField, string pkFieldValue)
        {
            string v = "";
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
        ...
        /// <param name="pkFieldValue">主键值</param>
        /// <returns></returns>
        private string getFieldValue_Oracle(MyCreek.Data.Model.DBConnection conn, string table, string field, string pkField, string pkFieldValue)
        {
            string v = "";
            using (OracleConnection sqlConn = new OracleConnection(conn.ConnectionString))
            {
        ...
        /// <returns></returns>
        public System.Data.IDbConnection GetConnection(MyCreek.Data.Model.DBConnection dbconn)
        {
        ...
        /// <returns></returns>
        public bool TestSql(MyCreek.Data.Model.DBConnection dbconn, string sql)
        {
            if (dbconn == null)
            {
                return false;
        ...
        /// <param name="linkID"></param>
        /// <returns></returns>
        public DataTable GetDataTable(MyCreek.Data.Model.DBConnection dbconn, string sql, IDataParameter[] parameterArray = null)
        {
            if (dbconn == null || dbconn.Type.IsNullOrEmpty() || dbconn.ConnectionString.IsNullOrEmpty())
            {
                return null;
