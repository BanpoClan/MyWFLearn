...
namespace MyCreek.Platform
{
    public class Users
    {
        ...
        private MyCreek.Data.Interface.IUsers dataUsers;
        public Users()
        {
        ...
        {
            return MyCreek.Utility.Config.SystemInitPassword;
        }
        /// <summary>
        /// 得到加密后的密码字符串
        /// </summary>
        ...
        public string EncryptionPassword(string password)
        {
            ...
            MyCreek.Utility.HashEncrypt hash = new MyCreek.Utility.HashEncrypt();
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.Users> GetAllByOrganizeID(Guid organizeID)
        {
        ...
        /// <param name="organizeID"></param>
        /// <returns></returns>
        public List<MyCreek.Data.Model.Users> GetAllByOrganizeIDArray(Guid[] organizeIDArray)
        {
        ...
        public static MyCreek.Data.Model.Users CurrentUser
        {
            get
            {
                object obj = System.Web.HttpContext.Current.Session[MyCreek.Utility.Keys.SessionKeys.User.ToString()];
                if (obj == null)
                {
                    ...
                    else
                    {
                        ...
                        if (user != null)
                        {
                            System.Web.HttpContext.Current.Session[MyCreek.Utility.Keys.SessionKeys.User.ToString()] = user;
                        }
                        return user;
                    }
                }
                ...
                {
                    return obj as MyCreek.Data.Model.Users;
                }
            }
        }
        ...
        public string GetLeader(Guid userID)
        {
            ...
            MyCreek.Platform.Organize borg = new Organize();
    ...
    public class UsersEqualityComparer : IEqualityComparer<MyCreek.Data.Model.Users>
    {
        public bool Equals(MyCreek.Data.Model.Users user1, MyCreek.Data.Model.Users user2)
        {
            return user1 == null || user2 == null || user1.ID == user2.ID;
        }
        public int GetHashCode(MyCreek.Data.Model.Users user)
        {
