...
namespace MyCreek.Platform
{
    ...
    public class WorkFlowForm
    {
        ...
        private MyCreek.Data.Interface.IWorkFlowForm dataWorkFlowForm;
		public WorkFlowForm()
		{
        ...
        public string GetValidatePropTypeRadios(string name, string value, string att = "")
        {
            ...
            return MyCreek.Utility.Tools.GetRadioString(items, name, att);
        }
        ...
        public string GetEventOptions(string name, string value, string att = "")
        {
            ...
            return MyCreek.Utility.Tools.GetOptionsString(items);
        }
        ...
        public string GetDefaultValueSelect(string value)
        {
            ...
            options.AppendFormat("<option value=\"u_@MyCreek.Platform.Users.CurrentUserID.ToString()\" {0}>当前步骤用户ID</option>", "10" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Platform.Users.CurrentUserName)\" {0}>当前步骤用户姓名</option>", "11" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Platform.Users.CurrentDeptID)\" {0}>当前步骤用户部门ID</option>", "12" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Platform.Users.CurrentDeptName)\" {0}>当前步骤用户部门名称</option>", "13" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"u_@(new MyCreek.Platform.WorkFlowTask().GetFirstSnderID(FlowID.ToGuid(), GroupID.ToGuid(), true))\" {0}>流程发起者ID</option>", "14" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(new MyCreek.Platform.Users().GetName(new MyCreek.Platform.WorkFlowTask().GetFirstSnderID(FlowID.ToGuid(), GroupID.ToGuid(), true)))\" {0}>流程发起者姓名</option>", "15" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(new MyCreek.Platform.WorkFlowTask().GetFirstSnderDeptID(FlowID.ToGuid(), GroupID.ToGuid()))\" {0}>流程发起者部门ID</option>", "16" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(new MyCreek.Platform.Users().GetName(new MyCreek.Platform.WorkFlowTask().GetFirstSnderDeptID(FlowID.ToGuid(), GroupID.ToGuid())))\" {0}>流程发起者部门名称</option>", "17" == value ? "selected=\"selected\"" : "");
            options.Append("<optgroup label=\"日期时间相关选项\"></optgroup>");
            options.AppendFormat("<option value=\"@(MyCreek.Utility.DateTimeNew.ShortDate)\" {0}>短日期格式(2014-4-15)</option>", "20" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Utility.DateTimeNew.LongDate)\" {0}>长日期格式(2014年4月15日)</option>", "21" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Utility.DateTimeNew.ShortTime)\" {0}>短时间格式(23:59)</option>", "22" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Utility.DateTimeNew.LongTime)\" {0}>长时间格式(23时59分)</option>", "23" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Utility.DateTimeNew.ShortDateTime)\" {0}>短日期时间格式(2014-4-15 22:31)</option>", "24" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@(MyCreek.Utility.DateTimeNew.LongDateTime)\" {0}>长日期时间格式(2014年4月15日 22时31分)</option>", "25" == value ? "selected=\"selected\"" : "");
        ...
        public string GetOrgSelectTypeCheckboxs(string name, string value, string att = "")
        {
            ...
            return MyCreek.Utility.Tools.GetCheckBoxString(items, name, value.Split(','), att);
        }
        ...
        { 
            ...
            return MyCreek.Utility.Tools.GetOptionsString(items.ToArray());
        }
        ...
        public string GetRadioFromSql(string connID, string sql, string name, string value, string attr = "")
        {
            ...
            return MyCreek.Utility.Tools.GetRadioString(items.ToArray(), name, attr);
        }
        ...
        public string GetCheckboxFromSql(string connID, string sql, string name, string value, string attr="")
        {
            ...
            return MyCreek.Utility.Tools.GetCheckBoxString(items.ToArray(), name, (value ?? "").Split(','), attr);
        }
        ...
        public string GetFormGridHtml(string connID, string dataFormat, string dataSource, string dataSource1)
        {
            ...
            { 
                ...
                case "1":
                    ...
                    try
                    {
                        str = MyCreek.Utility.HttpHelper.SendGet(dataSource1);
                        switch (dataFormat)
                        {
                            case "0":
                            case "1":
                ...
                case "2":
                    MyCreek.Data.Model.WorkFlowCustomEventParams eventParams = new MyCreek.Data.Model.WorkFlowCustomEventParams();
        ...
        /// 查询一个分类所有记录
        /// </summary>
        public List<MyCreek.Data.Model.WorkFlowForm> GetAllByType(Guid id)
        {
