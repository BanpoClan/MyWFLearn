...
namespace MyCreek.Platform
{
    public class Log
    {
        private MyCreek.Data.Interface.ILog dataLog;
        private static MyCreek.Data.Interface.ILog dataLog1 = Data.Factory.Factory.GetLog();
        private delegate void dgWriteLog(MyCreek.Data.Model.Log log);
        public Log()
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.Log> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public MyCreek.Data.Model.Log Get(Guid id)
        {
        ...
        {
            return dataLog.GetPagerData(out pager, query, MyCreek.Utility.Tools.GetPageSize(), MyCreek.Utility.Tools.GetPageNumber(),
