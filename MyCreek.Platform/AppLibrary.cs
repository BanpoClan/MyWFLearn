...
namespace MyCreek.Platform
{
    ...
    {
        private string cacheKey = MyCreek.Utility.Keys.CacheKeys.AppLibrary.ToString();
        private MyCreek.Data.Interface.IAppLibrary dataAppLibrary;
        public AppLibrary()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(MyCreek.Data.Model.AppLibrary model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(MyCreek.Data.Model.AppLibrary model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<MyCreek.Data.Model.AppLibrary> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            else
            {
                ...
                if (obj != null)
                {
                    return obj as List<MyCreek.Data.Model.AppLibrary>;
                }
                else
                {
        ...
        /// 查询单条记录
        /// </summary>
        public MyCreek.Data.Model.AppLibrary Get(Guid id, bool fromCache=false)
        {
            if (!fromCache)
            {
        ...
        {
            MyCreek.Cache.IO.Opation.Remove(cacheKey);
        }
        /// <summary>
        /// 删除
        /// </summary>
        ...
        /// <returns></returns>
        public List<MyCreek.Data.Model.AppLibrary> GetPagerData(out string pager, string query = "", string title = "", string type = "", string address = "")
        {
            return dataAppLibrary.GetPagerData(out pager, query, "Type,Title", MyCreek.Utility.Tools.GetPageSize(),
                MyCreek.Utility.Tools.GetPageNumber(), title, type, address);
        }
        /// <summary>
        /// 查询一个类别下所有记录
        /// </summary>
        public List<MyCreek.Data.Model.AppLibrary> GetAllByType(Guid type)
        {
            if (type.IsEmptyGuid())
            {
                return new List<MyCreek.Data.Model.AppLibrary>();
            }
        ...
        /// 根据代码查询一条记录
        /// </summary>
        public MyCreek.Data.Model.AppLibrary GetByCode(string code)
        {
        ...
        /// <returns></returns>
        public string GetFlowRunAddress(MyCreek.Data.Model.AppLibrary app, string query="")
        {
        ...
        {
            string key = MyCreek.Utility.Keys.CacheKeys.AppLibraryUseMember.ToString();
            var obj = MyCreek.Cache.IO.Opation.Get(key);
