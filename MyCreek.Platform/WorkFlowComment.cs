...
namespace MyCreek.Platform
{
    ...
    {
        private MyCreek.Data.Interface.IWorkFlowComment dataWorkFlowComment;
        ...
        {
            string key = MyCreek.Utility.Keys.CacheKeys.WorkFlowComments.ToString();
            if (!fromCache)
            {
        ...
        {
            MyCreek.Cache.IO.Opation.Remove(MyCreek.Utility.Keys.CacheKeys.WorkFlowComments.ToString());
        }
        /// <summary>
        /// 刷新缓存
        /// </summary>
        ...
        {
            MyCreek.Cache.IO.Opation.Set(MyCreek.Utility.Keys.CacheKeys.WorkFlowComments.ToString(), getAllListByDb());
        }
        /// <summary>
        /// 得到一个用户的所有意见
        /// </summary>
