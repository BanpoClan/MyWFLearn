...
namespace RoadFlow.Platform
{
    public class WorkFlowTask : IEqualityComparer<RoadFlow.Data.Model.WorkFlowTask>
    {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        private bool IsPassing(RoadFlow.Data.Model.WorkFlowInstalledSub.Step step, Guid flowID, Guid groupID, Guid taskID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        private bool IsBack(RoadFlow.Data.Model.WorkFlowInstalledSub.Step step, Guid flowID, Guid groupID, Guid taskID)
        {
            var tasks = GetTaskList(flowID, step.ID, groupID).FindAll(p => p.PrevID == taskID);
            if (tasks.Count == 0)
            {
