...
namespace WebForm.Common
{
    public class CustomFormSave
    {
        ...
        public static string Test(RoadFlow.Data.Model.WorkFlowCustomEventParams eventParams)
        {
            RoadFlow.Platform.Log.Add("执行了提交后事件", eventParams.Serialize(), RoadFlow.Platform.Log.Types.流程相关);
            return "1";
        }
