    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%">
        <tr>
            <td>
                ...
                所属流程：<select class="mycombox" style="width:150px;" width1="166" multiple="multiple" id="FlowID" name="FlowID"><asp:Literal ID="flowOptions" runat="server"></asp:Literal></select>
