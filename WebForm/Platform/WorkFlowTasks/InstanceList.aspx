    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%">
        <tr>
            <td>
                ...
                流程：<select class="mycombox" style="width:100px;" width1="156" multiple="multiple" id="FlowID" name="FlowID"><asp:Literal ID="FlowOptions" runat="server"></asp:Literal></select>
