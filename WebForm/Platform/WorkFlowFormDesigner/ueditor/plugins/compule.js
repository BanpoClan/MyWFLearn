UE.compule = {
    ...
    getRadioOrCheckboxHtml: function ($control, type)
    {
        ...
        if ("0" == datasource)//数据字典
        {
            ...
            if ('radio' == type)
            {
                radios = '<span><%=BDictionary.GetRadiosByID("' + dictid + '".ToGuid(), "' + id + '", MyCreek.Platform.Dictionary.OptionValueField.ID, "' + defaultvalue + '", "isflow=\'1\' type1=\'flow_radio\'' + eventArrs + '")%>' + eventScripts + '</span>';
            }
            else if ('checkbox' == type)
            {
                radios = '<span><%=BDictionary.GetCheckboxsByID("' + dictid + '".ToGuid(), "' + id + '", MyCreek.Platform.Dictionary.OptionValueField.ID, "' + defaultvalue + '", "isflow=\'1\' type1=\'flow_checkbox\'' + eventArrs + '")%>' + eventScripts + '</span>';
            }
        ...
        else if ("2" == datasource)//SQL
        {
            ...
            if ("radio" == type)
            {
                radios += '<span><%=new MyCreek.Platform.WorkFlowForm().GetRadioFromSql("' + dbconn + '", "' + sql.replaceAll('"', '\"') + '", "' + id + '", "' + defaultvalue + '", "isflow=\'1\' type1=\'flow_radio\'' + eventArrs + '")%>' + eventScripts + '</span>';
            }
            else if ("checkbox" == type)
            {
                radios += '<span><%=new MyCreek.Platform.WorkFlowForm().GetCheckboxFromSql("' + dbconn + '", "' + sql.replaceAll('"', '\"') + '", "' + id + '", "' + defaultvalue + '", "isflow=\'1\' type1=\'flow_checkbox\'' + eventArrs + '")%>' + eventScripts + '</span>';
            }
            $control.after(radios);
            $control.remove();
        }
    ...
    getSelectHtml: function ($control)
    {
        ...
        if ("0" == datasource)//数据字典
        {
            ...
            radios += '<%=BDictionary.GetOptionsByID("' + dictid + '".ToGuid(), MyCreek.Platform.Dictionary.OptionValueField.ID, "' + defaultvalue + '")%>';
            radios += '</select>';
            var $radios = $(radios);
        ...
        else if ("2" == datasource)//SQL
        {
            ...
            radios += '<%=new MyCreek.Platform.WorkFlowForm().GetOptionsFromSql("' + dbconn + '", "' + sql.replaceAll('"', '\"') + '", "' + defaultvalue + '")%>';
            radios += '</select>';
            var $radios = $(radios);
            $radios.attr("eventsid", $control.attr("eventsid"));
            $control.after($radios);
    ...
    getComboxHtml: function ($control)
    {
        ...
        if ("0" == datasource)//数据字典
        {
            ...
            {
                var dictid = $control.attr("dictid");
                var radios = '<select class="mycombox" id="' + id + '" name="' + id + '" ' + ("1" == ismultiple ? ' multiple="multiple"' : '') + (width1 ? ' style="width:' + width1 + '"' : '') + (width2 ? 'width1="' + width2 + '"' : '') + (height1 ? 'height1="' + height1 + '"' : '') + ' datasource="' + datasource + '" listmode="' + listmode + '" isflow="1" type1="flow_combox">';
                if ("1" == hasempty)
                {
                    radios += '<option value=""></option>';
                }
            ...
            else
            {
                ...
                table += '>';
                table += '<%=BDictionary.GetComboxTableHtmlByID("' + dictid + '",MyCreek.Platform.Dictionary.OptionValueField.ID,"' + defaultvalue + '")%>';
                table += '</span>';
                var $table = $(table);
        ...
        else if ("2" == datasource)//SQL
        {
            ...
            else
            {
                ...
                table += "1" == ismultiple ? ' multiple="multiple"' : '';
                table += '>';
                table += '<%=new MyCreek.Platform.WorkFlowForm().GetComboxTableHtmlFromSql("' + dbconn + '", "' + sql.replaceAll('"', '\"') + '", "' + defaultvalue + '")%>';
                table += '</span>';
                var $table = $(table);
                $table.attr("eventsid", $control.attr("eventsid"));
                $control.after($table);
        ...
        else if ("3" == datasource)//URL
        {
            if ("1" != listmode)
            {
                ...
                radios += '<%=new MyCreek.Platform.WorkFlowForm().GetOptionsFromUrl("' + encodeURI(url) + '", "' + defaultvalue + '")%>';
                radios += '</select>';
                var $radios = $(radios);
                $radios.attr("eventsid", $control.attr("eventsid"));
                $control.after($radios);
    ...
    getGridHtml: function ($control)
    {
        ...
        div += '" >';
        div += '<%=new MyCreek.Platform.WorkFlowForm().GetFormGridHtml(DBConnID, "' + $control.attr("dataformat") + '","' + $control.attr("datasource") + '","' + $control.attr("datasource1") + '")%>';
        div += '</div>';
        $control.after(div);
        $control.remove();
    },
    ...
    getSubTableHtml_Select: function (colnumJSON, id, i, iscount)
    {
        ...
        switch (ds)
        {
            case "select_dsdict":
                ...
                select += '<%=BDictionary.GetOptionsByID("' + rootid + '".ToGuid(), MyCreek.Platform.Dictionary.OptionValueField.ID, "' + dvalue + '")%>';
                break;
            case "select_dssql":
                ...
                select += '<%=new MyCreek.Platform.WorkFlowForm().GetOptionsFromSql("' + conn + '", "' + sql.replaceAll('"', '\"') + '", "' + dvalue + '")%>';
                break;
    ...
    getSubTableHtml_Checkbox: function (colnumJSON, id, i, iscount)
    {
        ...
        switch (ds)
        {
            case "checkbox_dsdict":
                ...
                checkbox = '<span><%=BDictionary.GetCheckboxsByID("' + rootid + '".ToGuid(), "' + name + '", MyCreek.Platform.Dictionary.OptionValueField.ID, "' + dvalue + '", "issubflow=\'1\' type1=\'subflow_checkbox\' colname=\'' + colnumJSON.name + '\'")%></span>';
                break;
            case "checkbox_dssql":
                var conn = editmode.checkbox_ds_dbconn;
                var sql = editmode.checkbox_ds_sql;
                checkbox = '<%=new MyCreek.Platform.WorkFlowForm().GetCheckboxFromSql("' + conn + '", "' + sql.replaceAll('"', '\"') + '", "' + name + '", "' + dvalue + '", "issubflow=\'1\' type1=\'subflow_checkbox\' colname=\'' + colnumJSON.name + '\'")%>';
                break;
    ...
    getSubTableHtml_Radio: function (colnumJSON, id, i, iscount)
    {
        ...
        switch (ds)
        {
            case "radio_dsdict":
                ...
                radio = '<span><%=BDictionary.GetRadiosByID("' + rootid + '".ToGuid(), "' + name + '", MyCreek.Platform.Dictionary.OptionValueField.ID, "' + dvalue + '", "issubflow=\'1\' type1=\'subflow_radio\' colname=\'' + colnumJSON.name + '\'")%></span>';
                break;
            case "radio_dssql":
                var conn = editmode.radio_ds_dbconn;
                var sql = editmode.radio_ds_sql;
                radio = '<%=new MyCreek.Platform.WorkFlowForm().GetRadioFromSql("' + conn + '", "' + sql.replaceAll('"', '\"') + '", "' + name + '", "' + dvalue + '", "issubflow=\'1\' type1=\'subflow_radio\' colname=\'' + colnumJSON.name + '\'")%>';
                break;
            case "radio_dsstring":
