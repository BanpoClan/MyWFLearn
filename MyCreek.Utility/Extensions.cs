...
public static class MyExtensions
{
    ...
    {
        return MyCreek.Utility.Encryption.Encrypt(str);
    }
    /// <summary>
    /// AES解密字符串
    /// </summary>
    ...
    {
        return MyCreek.Utility.Encryption.Decrypt(str);
    }
    ...
    {
        return MyCreek.Utility.EncryptionDes.Encrypt(str);
    }
    /// <summary>
    /// DES解密字符串
    /// </summary>
    ...
    {
        return MyCreek.Utility.EncryptionDes.Decrypt(str);
    }
    ...
    {
        return date.ToDateTime().ToString(MyCreek.Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(MyCreek.Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(MyCreek.Utility.Config.DateTimeFormatS);
    }

    public static string ToDateString(this DateTime date)
    {
        return date.ToString(MyCreek.Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this DateTime dateTime)
    {
        return dateTime.ToString(MyCreek.Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this DateTime dateTime)
    {
        return dateTime.ToString(MyCreek.Utility.Config.DateTimeFormatS);
    }
}
