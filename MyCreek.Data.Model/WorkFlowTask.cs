...
namespace MyCreek.Data.Model.WorkFlowExecute
{
    /// <summary>
    /// 任务相关的枚举类型
    /// </summary>
    ...
    public class Execute
    {
        ...
        /// 发送人员
        /// </summary>
        public MyCreek.Data.Model.Users Sender { get; set; }
        /// <summary>
        /// 接收的步骤和人员
        /// </summary>
        public Dictionary<Guid, List<MyCreek.Data.Model.Users>> Steps { get; set; }
        /// <summary>
        /// 处理意见
        /// </summary>
        public string Comment { get; set; }
    ...
    public class Result
    {
        ...
        /// 后续任务
        /// </summary>
        public IEnumerable<MyCreek.Data.Model.WorkFlowTask> NextTasks { get; set; }
    }
