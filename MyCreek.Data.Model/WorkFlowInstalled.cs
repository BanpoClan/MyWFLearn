...
namespace MyCreek.Data.Model
{
    ...
    public class WorkFlowInstalled
    {
        ...
        /// 调试人员
        /// </summary>
        public List<MyCreek.Data.Model.Users> DebugUsers { get; set; }
...
namespace MyCreek.Data.Model.WorkFlowInstalledSub
{
    /// <summary>
    /// 数据库连接结构体
    /// </summary>
...
namespace MyCreek.Data.Model.WorkFlowInstalledSub.StepSet
{
    /// <summary>
    /// 步骤行为实体
    /// </summary>
